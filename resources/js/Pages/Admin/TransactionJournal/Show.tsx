...
return (
    <DashboardAdminLayout title={`Jurnal Transaksi ${user.date}`}>
                ...
                <div className="p-6 sm:px-20 bg-white border-b border-gray-200">
                    <div className="flex flex-col gap-3 shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                        ...
                        <table className='w-full'>
                            ...
                            <tbody>
                                <tr className='border-b py-3 border-black'>
                                    <td className='py-3 text-center'>Sub-akun</td>
                                    <td className='py-3 text-center'>{user.id}</td>
                                </tr>
                                <tr className='border-b py-3 border-black'>
                                    <td className='py-3 text-center'>Deskripsi</td>
                                    <td className='py-3 text-center'>{user.description}</td>
                                </tr>
                                <tr className='border-b py-3 border-black'>
                                    <td className='py-3 text-center'>Tanggal</td>
                                    <td className='py-3 text-center'>{user.date}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
